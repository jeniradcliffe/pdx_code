...
while True:
    ...
    if user == computer: #!!!!!!!!!!!!!!!!!!!!!!!!!! "users" should be "user"
        print("Looks like a tie") #!!!!!!!!!!!!!!!!!!!!!!!!!! parentheses needed to be closed  
    ...
    # check all cases if user is rock
        ...
        # check losing case
        elif computer == "paper": #!!!!!!!!!!!!!!!!!!!!!!!!!! changed from "rock" to "paper" to capture all scenarios
    ...
    # check all cases if user is scissors
        ...
        # check losing case
            ...
            print("Sorry, You lose.") #!!!!!!!!!!!!!!!!!!!!!!!!!! print needed to be all lowercase